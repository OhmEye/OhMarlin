...
#ifdef REVERSE_ENCODER //ohmeye not sure this is at all a proper place for this, but my GLCD clone needs encoder rotation direction reversed
#define encrot0 0
#define encrot1 1
#define encrot2 3
#define encrot3 2
...
static void lcd_implementation_status_screen() {
  ...
  u8g.print(ftostr311(current_position[Z_AXIS]));
  u8g.setColorIndex(1); // black on white
