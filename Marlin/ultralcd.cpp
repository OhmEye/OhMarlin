...
static void lcd_ohmeye_menu()
{
        ...
        #endif
        MENU_ITEM(function, MSG_OHMEYE_HEAT_PLA, lcd_preheat_pla0);
        MENU_ITEM(function, MSG_OHMEYE_HEAT_ABS, lcd_preheat_abs0);        
...
static void lcd_ohmeye_disable()
{
        ...
        enquecommands_P(PSTR("M106 S0"));
}

static void lcd_ohmeye_all_off()
{
        enquecommands_P(PSTR("M84"));
        enquecommands_P(PSTR("M104 S0"));
        enquecommands_P(PSTR("M140 S0"));
        enquecommands_P(PSTR("M106 S0"));
}
...
=======
	plan_set_position(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS], current_position[E_AXIS]);
>>>>>>> b57d44b38a92927b551f9a1f0f1c92cba762b0f2
}
